...
public class SaveMenuAllocationTypeModel extends AuditIdModelOnly {

	@ManyToOne
	@JoinColumn(name = "fk_order_menu_preparation_menu_item_id", referencedColumnName = "id")
	private SaveMenuPreparationMenuItemModel menuPreparationMenuItem;
